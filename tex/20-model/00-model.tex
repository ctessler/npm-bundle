...
strictly increasing discrete concave (detailed in Subsection~\ref{sec:discrete-growth}). Thread-level schedulers that
...
than ${m_i}$ jobs of one thread. It is this relationship which the
scheduling behavior and analysis exploit. 
