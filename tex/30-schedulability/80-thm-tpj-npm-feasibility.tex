\begin{theorem}[\tpj{} is Optimal with Respect to npm-feasibility]
  ...
  \begin{proof}
    ...
    where every job of \task{i} executes  non-preemptively for
    ...
    Since \ants{} is npm-feasible by assumption, the infeasibility
    conditions on Lines~\ref{line:no-slack-infease}
    and~\ref{line:more-demand} of \tpj{} indicate that the demand of 
    ${\dot{\tasks{}}}$ is too great. However, \tpj{} added each
    partial set \Partial{k} to ${\dot{\tasks{}}}$ in increasing
    relative deadline order. By Property~\ref{prop:divisions}, every 
