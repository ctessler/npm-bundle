...
synthetic task sets and a case study based upon the evaluation of
\bundlep{}~\cite{Tessler:2018b}. The ratio of task set specifications
deemed schedulable by \tpj{} for EDF-NP will be compared to \npchunks{} in
...
tasks \tpj{} could schedule, but EDF-P:1 could not (even) when CRPD
values are zero.
